...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhpYWdvZmFsY29uZXIiLCJhIjoiY2w2cjM3aGwzMDd3MzNjcDgzOG9hYmFzcCJ9.Alk2zvbbtn8yEwly0Z2nMg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/thiagofalconer/cl6s6txnq000x15p66aay9ep2',
    // style URL
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extend map bounds to include current localtion
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LYKf7BHlvkkAyPZM9eDvP9bEs1FgwJlR4OYQZGQGu5C7MDQoElt8BuRZrXsIP7QC5RW0FocHPlPwhiLdOf6EssL00OzDuWblA');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            console.log(session); //2. create checkout form + charge credic card
